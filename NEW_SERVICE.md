...
2. rename all the custom-service pieces to your new service name. (TODO where are all those?)
3. update readme to reflect what this service is about
3. change README sections to be links to README in custom-service (if you don't want to modify those sections, linking to
